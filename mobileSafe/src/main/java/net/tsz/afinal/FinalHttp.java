...
public class FinalHttp {
	...
	public FinalHttp(Context context ,boolean cookieSupport){
		this();
		if(cookieSupport){		
			preferencesCookieStore=new PreferencesCookieStore(context);
			httpClient.setCookieStore(preferencesCookieStore);
		}
	}
    ...
    public FinalHttp() {
        ...
        httpParams.setParameter(ALLOW_CIRCULAR_REDIRECTS, true);

...
public class FinalDb {
	...
	public void save(Object entity) {
		...
		syncTableColum(entity.getClass());
	 ...
	 * @param columNames
	 */
	public void addTableColums(Class<?> clazz,Map<String,String> map) {
		TableInfo info = TableInfo.get(clazz);
		for(String column:map.keySet()) {
			String sql = " ALTER TABLE "+info.getTableName()+" ADD COLUMN "+ column + " " +map.get(column);
			debugSql(sql);
			db.execSQL(sql);
		}
	 ...
	 * @param clazz
	 */
	public void syncTableColum(Class<?> clazz) {
//		Map<String,String> map =new HashMap<String, String>();
//		TableInfo info = TableInfo.get(clazz);
//		Field[] fields = clazz.getDeclaredFields();
//		for(Field f:fields) {
//			f.setAccessible(true);
//			if(!checkColumnExists(info.getTableName(), f.getName())) {
//				map.put(f.getName(), toSqliteType(f.getType()));
//			}
//		}
//		addTableColums(clazz, map);
	 ...
	 * @return
	 */
	private String toSqliteType(Class<?> clazz) {

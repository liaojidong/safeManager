...
public class DialogPlus {
    ...
    /**
     * Determines the position of the dialog_loading, only BOTTOM and TOP should be used, as default
     * it is BOTTOM
     */
    ...
    /**
     * Determines whether dialog_loading should be dismissed by back button or touch in the black overlay
     */
    private final boolean isCancelable;

    /**
     * Determines whether dialog_loading is showing dismissing animation and avoid to repeat it
     */
    private boolean isDismissing;

    /**
     * topView and bottomView are used to set the position of the dialog_loading
     ...
     * to set header/footer for the dialog_loading content
     */
    ...
    /**
     * Determines the in and out animation of the dialog_loading. Default animation are bottom sliding animations
     */
    private final int inAnimationResource;
    private final int outAnimationResource;

    /**
     * Determine the margin that the dialog_loading should have
     */
     ...
     *
     * @param gravity       the gravity of the dialog_loading
    ...
    /**
     * It adds the dialog_loading view into rootView which is decorView of activity
     */
    public void show() {
        if (isShowing()) {
            return;
    ...
    /**
     * It basically check if the rootView contains the dialog_loading plus view.
     *
    ...
    /**
     * It is called when to dismiss the dialog_loading, either by calling dismiss() method or with cancellable
     */
    public void dismiss() {
        if (isDismissing) {
            return;
    ...
    /**
     * It is called to set whether the dialog_loading is cancellable by pressing back button or
    ...
    /**
     * It is called when the set the position of the dialog_loading
     */
     ...
     *
     * @param inflater  used to inflate the content of the dialog_loading
     *
     ...
     *
     * @param view is the dialog_loading plus view
     */
    ...
    /**
     * Called when the user touch on black overlay in order to dismiss the dialog_loading
     */
    ...
    /**
     * Use this builder to create a dialog_loading
     */
    public static class Builder {
        ...
        /**
         * Initialize the builder with a valid context in order to inflate the dialog_loading
         */
        ...
        /**
         * Define if the dialog_loading is cancelable and should be closed when back pressed or click outside is pressed
         */
        ...
        /**
         * Set the content of the dialog_loading by passing one of the provided Holders
         */
        ...
        /**
         * Set background color for your dialog_loading. If no resource is passed 'white' will be used
         */
        ...
        /**
         * Set the gravity you want the dialog_loading to have among the ones that are provided
         */
        ...
        /**
         * Set how much big you want the dialog_loading to be (full screen or half screen)
         */
        ...
        /**
         * Add margins to your dialog_loading. They are set to 0 except when gravity is center. In that case basic margins
         * are applied
         */
        ...
        /**
         * Set a global click listener to you dialog_loading in order to handle all the possible click events. You can then
        ...
        /**
         * Create the dialog_loading using this builder
         */

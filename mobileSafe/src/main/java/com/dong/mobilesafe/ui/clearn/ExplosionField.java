package com.dong.mobilesafe.ui.clearn;
...
public class ExplosionField extends View{
     ...
     */
    public void explode(final View view, final OnExplodeListener listener) {
        Rect rect = new Rect();
        view.getGlobalVisibleRect(rect); //得到view相对于整个屏幕的坐标
        rect.offset(0, -DensityUtil.dip2px(getContext(),30)); //去掉状态栏高度
